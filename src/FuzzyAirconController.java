...
public class FuzzyAirconController extends PApplet{
    ...
    public void createFuzzyEngine(){
        ...
        inputVariable1.addTerm(new Trapezoid("toocold", 0, 0, 5, 12.5));
        inputVariable1.addTerm(new Trapezoid("cold", 7.5, 10, 15, 20));
        inputVariable1.addTerm(new Triangle("warm", 12.5, 20, 27.5));
        inputVariable1.addTerm(new Trapezoid("hot", 22.5, 25, 30, 35));
        inputVariable1.addTerm(new Trapezoid("toohot", 27.5, 35, 40, 40));
        ...
        inputVariable2.addTerm(new Trapezoid("toocold", 0, 0, 5, 12.5));
        inputVariable2.addTerm(new Trapezoid("cold", 7.5, 10, 15, 20));
        inputVariable2.addTerm(new Triangle("warm", 12.5, 20, 27.5));
        inputVariable2.addTerm(new Trapezoid("hot", 22.5, 25, 30, 35));
        inputVariable2.addTerm(new Trapezoid("toohot", 27.5, 35, 40, 40));
        ...
        ruleBlock.addRule(Rule.parse("if room is toocold and target is toocold then command is normal", engine));
        ruleBlock.addRule(Rule.parse("if room is cold and target is cold then command is normal", engine));
        ruleBlock.addRule(Rule.parse("if room is warm and target is warm then command is normal", engine));
        ruleBlock.addRule(Rule.parse("if room is hot and target is hot then command is normal", engine));
        ruleBlock.addRule(Rule.parse("if room is toohot and target is toohot then command is normal", engine));

        ruleBlock.addRule(Rule.parse("if (room is toohot or room is hot or room is warm  or room is cold) and (target is toocold) then command is cool", engine));
     
        ruleBlock.addRule(Rule.parse("if (room is toohot or room is hot or room is warm) and (target is cold) then command is cool", engine));
        ruleBlock.addRule(Rule.parse("if (room is toocold) and target is cold then command is heat", engine));
        

        ruleBlock.addRule(Rule.parse("if (room is toocold or room is cold) and target is warm then command is heat", engine));
        ruleBlock.addRule(Rule.parse("if (room is toohot or room is hot) and target is warm then command is cool", engine));
        
        ruleBlock.addRule(Rule.parse("if (room is toocold or room is cold or room is warm) and (target is hot) then command is heat", engine));
        ruleBlock.addRule(Rule.parse("if (room is toohot) and target is hot then command is cool", engine));
        
        ruleBlock.addRule(Rule.parse("if (room is warm or room is hot or room is toocold or room is cold) and (target is toohot) then command is heat", engine));
